...
var port = Math.floor(Math.random() * (999)) + 7000,
    api = superTest(server(port, true));

// helper function to return a new note object
function newNote() {
    return {
...
// helper function to parse a json body
function parse(body) {
    var json = {};
